  ...
  return (
    <>
      <button
        ...
        className={`md:hidden fixed top-5 sm:left-0 -left-1 p-3 h-fit bg-transparent rounded-md z-50 transition-all duration-300 ${isOpen ? 'opacity-0 pointer-events-none' : ''
          }`}
      ...
      >
        <div className="px-3 py-5 border-b-[1px]">
          <Link to="/" className="flex items-center gap-1 text-[24px]">
            <ICONS.leftArrowSlider size={32} /> Exit
          </Link>
        </div>
        <div>
